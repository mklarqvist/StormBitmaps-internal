...
const Variant<fn_br> kBR[] = {
    ...
    {"hybrid1",     br_hybrid<1>,             "crossover probe: rank above 1 word",        true},
    {"hybrid16",    br_hybrid<16>,            "crossover probe: rank above 16 words",      true},
    {"hybrid64",    br_hybrid<64>,            "crossover probe: rank above 64 words",      true},
