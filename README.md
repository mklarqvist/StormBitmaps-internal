...
|---|---|---:|---:|---:|---:|---|---|
| enwiki-categorylinks | IR | 129,698,523 | 32.9 | 11.8 | **2.77×** | 2.07–3.35 | B×S=55.5% S×S=33.6% ∅=10.9% |
| uscensus2000 | census | 36,974,578 | 11.9 | 5.1 | **2.31×** | 2.28–3.06 | B×S=41.1% S×S=4.1% ∅=54.8% |
| dbpedia-link | graph | 18,268,993 | 101.9 | 52.7 | **1.94×** | 1.86–2.02 | B×S=98.6% ∅=1.4% |
| wikipedia_link_en | graph | 11,206,012 | 105.8 | 63.0 | **1.68×** | 1.50–1.76 | B×S=96.9% S×S=1.1% ∅=2.0% |
| livejournal-groupmemberships | graph | 7,489,074 | 28.6 | 17.2 | **1.66×** | 1.50–1.73 | B×S=54.9% S×S=23.1% ∅=21.9% |
| com-Orkut | graph | 3,072,627 | 203.9 | 95.1 | **2.07×** | 2.05–2.28 | B×S=99.5% ∅=0.5% |
| com-LiveJournal | graph | 4,036,538 | 48.9 | 35.4 | **1.41×** | 1.38–1.41 | B×S=81.6% S×S=3.6% ∅=14.8% |
| soc-Pokec | graph | 1,632,804 | 95.8 | 40.6 | **2.36×** | 2.31–2.40 | B×S=90.6% S×S=4.9% ∅=4.5% |
| as-skitter | graph | 1,696,415 | 26.2 | 23.2 | **1.13×** | 1.04–1.23 | B×S=73.9% S×S=8.9% ∅=17.2% |
| wiki-Talk | graph | 2,394,385 | 38.1 | 17.0 | **2.29×** | 2.19–2.41 | B×S=69.1% S×S=16.5% ∅=14.4% |
| dimension_003 | druid | 3,866,847 | 3.2 | 1.6 | **2.00×** | 1.98–2.12 | B×S=0.1% B×R=0.3% ∅=99.5% |
| dimension_008 | druid | 3,866,845 | 7.7 | 6.8 | **1.18×** | 0.99–1.28 | B×S=53.4% B×R=25.0% S×S=7.1% ∅=14.6% |
| dimension_033 | druid | 3,866,847 | 97.7 | 30.5 | **3.15×** | 3.05–3.33 | B×R=72.0% ∅=28.0% |
| census1881 | census | 4,277,806 | 50.3 | 56.4 | *0.89×* | 0.86–0.90 | B×B=0.1% B×S=34.0% S×S=2.6% ∅=63.3% |
| census1881_srt | census | 4,277,735 | 59.1 | 21.2 | **2.75×** | 2.65–2.79 | B×B=0.0% B×S=35.7% B×R=11.8% S×S=15.8% ∅=36.6% |
| wikileaks-noquotes | text | 1,353,179 | 374.1 | 82.7 | **4.52×** | 4.23–4.64 | B×B=0.1% B×S=23.8% B×R=39.0% S×S=0.9% ∅=36.1% |
| weather_sept_85 | sensor | 1,015,367 | 1451.4 | 1215.1 | **1.19×** | 1.13–1.31 | B×B=45.9% B×S=53.4% ∅=0.6% |
| census-income | census | 199,523 | 465.9 | 263.6 | **1.74×** | 1.65–2.33 | B×B=46.1% B×S=53.8% ∅=0.1% |
| usher_sarscov2 | genomics | 8,451,771 | 1037.1 | 549.4 | **1.83×** | 1.44–2.06 | B×S=74.5% B×R=25.0% ∅=0.5% |
| gnomad_chr21_exomes_af1e-3 | genomics | 1,461,894 | 63.8 | 23.3 | **2.74×** | 2.66–2.90 | B×S=70.2% S×S=12.3% ∅=17.4% |
| msprime_1M | genomics-sim | 2,000,000 | 1976.2 | 1323.2 | **1.54×** | 1.38–1.59 | B×B=14.0% B×S=83.7% S×S=0.4% ∅=1.9% |
| msprime_100k | genomics-sim | 200,000 | 233.5 | 133.2 | **1.77×** | 1.75–2.09 | B×B=14.0% B×S=83.7% S×S=0.4% ∅=1.9% |
| msprime_10k | genomics-sim | 20,000 | 91.1 | 22.9 | **3.91×** | 3.82–4.12 | B×B=25.0% B×S=72.4% S×S=0.3% ∅=2.4% |
