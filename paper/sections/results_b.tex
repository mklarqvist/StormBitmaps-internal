...
Supplementary Table~\ref{tab:corpus-inventory}, Supplementary Note~6). Every corpus is scored against
...
all-bitmap baseline. \textbf{Both ratios are oracle}: hindsight choice of representation pairing with
...
counterexample and is not omitted for being unflattering. \textbf{Both ratio columns are oracle}:
...
\textbf{Total chunks} sums the three container counts. Bold marks the plurality container type per
...
Table~\ref{tab:metadata}, Supplementary Note~7). Metadata built at ingest is meant to be amortised
