...
4096 (declared as
\texttt{enum \{ DEFAULT\_MAX\_SIZE = 4096 \}} at \texttt{roaring.h:2486}, and tested at dispatch as
\texttt{size <= DEFAULT\_MAX\_SIZE} at \texttt{roaring.h:5515}, in the pinned version below). The same fixed commitment prices a run container against a bitset by iterating every run and
