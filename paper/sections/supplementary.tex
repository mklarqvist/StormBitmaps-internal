...
\suppnote{Narrowing the query}
\label{note:narrowing}
...
KONECT graphs, UShER SARS-CoV-2, gnomAD and the
...
\texttt{\seqsplit{usher\_sarscov2}} & G4 & \prov{29{,}411} & \prov{8{,}451{,}771} & \prov{15{,}769.3} & \prov{1.87e-3} & UCSC UShER SARS-CoV-2; mean dominated by near-universal variants (max 99.7\% carriers), median only 404 \\
...
The impossibility (Corollary B), stated at the strength it is actually proved. Any selector
