...
\title{Work avoidance in sparse set algebra}

\author[1]{Marcus D. R. Klarqvist}
\affil[1]{\nm{affiliation}}

\keywords{set algebra; sparse computation; pairwise computation; all-pairs set intersection;
column postings; zone maps; adaptive representation; online optimization; work avoidance}
...
\input{sections/results_a}
\input{sections/results_b}
